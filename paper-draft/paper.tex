...
\title{MultiDiseaseAI: A Leakage-Safe Serving Pipeline Around a Tabular Foundation Model, and What Each Design Choice Buys on Four Small Clinical Datasets}

\author{\IEEEauthorblockN{Albert Mathew Suni}\IEEEauthorblockA{\textit{Reg. No. 23BCE1765} \\ Vellore Institute of Technology, Chennai, India}\and
\IEEEauthorblockN{Nandhitha S H}\IEEEauthorblockA{\textit{Reg. No. 23BCE1552} \\ Vellore Institute of Technology, Chennai, India}\and
\IEEEauthorblockN{Dr. Vijayraj J}\IEEEauthorblockA{\textit{Project Guide, Employee ID 54799} \\ Vellore Institute of Technology, Chennai, India}}
...
\textbf{Model.} Each disease gets \texttt{TabPFNClassifier(n\_estimators=8, random\_state=42)} on CPU with categorical column indices, package version 8.2.0, and no hyperparameter search. TabPFN is the only classifier in the shipped system.
